...
with open(model_name + '.html', 'w') as f:
    f.write('<!DOCTYPE html> <html> <head>' +
        ...
        <script src="https://code.jquery.com/jquery-3.5.1.min.js" defer async="true" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script> \
